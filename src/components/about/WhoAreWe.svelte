...
<div class="flex justify-center items-center" transition:fade|local>
    <div class="md:w-140">
        ...
        <div class="p-5 flex justify-evenly items-center">
            ...
            <div class="">
                <h3 class="text-xl md:text-2xl font-bold">Sunil Devaprabha PhD(HC)</h3>
                <h4>Founder/ Instructor</h4>
            </div>
        </div>
        <div class="p-5 flex justify-evenly items-center">
            <img src="/img/Bijo.jpg" alt="" class="w-36 md:w-48 rounded-full">
            <div class="">
                <h3 class="text-xl md:text-2xl font-bold">Bijo Thomas</h3>
                <h4>Overseas Head</h4>
            </div>
        </div>
