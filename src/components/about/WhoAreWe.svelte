<div class="flex justify-center items-center">
    <div class="md:w-140">
        ...
        <div class="p-5 flex justify-evenly items-center">
            <img src="/img/devaprabha1.jpeg" alt="" class="w-48 rounded-full">
            <div class="">
                <h3 class="text-2xl font-bold">Sunil Devaprabha</h3>
                <h4>Founder/ Instructor</h4>
            </div>
        </div>
        <div class="p-5 flex justify-evenly items-center">
            <img src="/img/Bijo.jpg" alt="" class="w-48 rounded-full">
            <div class="">
                <h3 class="text-2xl font-bold">Bijo</h3>
