<div class="bg-white p-5 w-full rounded w-86 md:w-110" id="#Phone">
    ...
    <div class="">
        ...
        <p class="p-2">
            <a class="font-bold " href="tel:+91-9446129722" >+91 9446129722 <div class="bg-red-400  text-white hover:bg-red-500 inline-block p-2"><i class="fas fa-phone-alt  text-white"></i></div> </a>
        </p>
